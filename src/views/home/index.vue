        ...
        <el-card shadow="hover">
          <div class="user">
            ...
            <el-upload style="margin-bottom: -120px;margin-right: -10px"
                       ...
                       :limit="1">
              <i class="iconfont icon-r-edit"> 修改头像</i>
            </el-upload>
            <img :src="avatar"/>
            <div class="userinfo">
      ...
      <el-col :span="16" style="margin-top: 20px">
        <div class="num">
          <el-card v-for="(item,index) in countData" :key="index" :body-style="{ display: 'flex', padding: 0 }">
            <i class="icon" :class="'iconfont icon-r-' +item.icon" :style="{ background: item.color }"/>
            <div class="detail">
        ...
        <el-card style="height: 300px">
          <div style="height: 300px;width: 100%;" ref="city"></div>
        </el-card>
        <div class="graph">
          <el-card style="height: 300px">
